...
$(function() {
    ...
    $('#search-form').submit(function() {
        ...
        if(!question) {
            ...
            $urlOutput.val('https://wzh-team.github.io/Let-Me-Search-That-For-You/google/' + '?q=' + Base64.encode(question)).focus().select();
        }
        return false;
    });
